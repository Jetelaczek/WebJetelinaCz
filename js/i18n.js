...
const translations = {
  en: {
    ...
    "projects.subtitle": "A selection of repositories I currently build and maintain.",
    ...
    "cv.subtitle": "Download my CV as a PDF in your preferred language.",
    "cv.downloadEn": "Download CV (English)",
    "cv.downloadCz": "Stáhnout CV (Česky)",
  ...
  cs: {
    ...
    "projects.subtitle": "Výběr repozitářů, které aktuálně vyvíjím a spravuji.",
    "projects.framework.title": "Framework",
    ...
    "cv.title": "Životopis",
    "cv.subtitle": "Stáhněte si můj životopis ve formátu PDF v preferovaném jazyce.",
    "cv.downloadEn": "Download CV (English)",
    "cv.downloadCz": "Stáhnout životopis (česky)",
